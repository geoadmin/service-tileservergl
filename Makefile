...
help:
	...
	@echo "- docker-build-[dev|int|prod]	Build all the images via docker compose"
	...
	@echo "- docker-push-[dev|int|prod]	Push locally builded images to dockerhub"
	@echo "- docker-pipe-[dev|int|prod]	Purge, build the images, retag them with the date and push that image to dockerhub"
